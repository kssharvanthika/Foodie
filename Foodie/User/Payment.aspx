...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="book_section"  width: 100%; height: 100%; background-repeat: no-repeat; 
                ...
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                        <div class="card-header">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div role="form">
                                        ...
                                        <div class="card-footer">
                                            <asp:LinkButton ID="lbCardSubmit" runat="server" CssClass="subscribe btn btn-info btn-block shadow-sm"
                                                ValidationGroup="card" onclick="lbCardSubmit_Click2">Confirm Payment</asp:LinkButton>
                                        </div>
                                    </div>
                                </div>
                                <!-- End -->
                                ...
                                <div id="paypal" class="tab-pane fade pt-3">
                                    ...
                                    <p>
                                        <asp:LinkButton ID="lbCodSubmit" runat="server" CssClass="btn btn-info" ValidationGroup="cod" onClick="lbCodSubmit_Click1">
                        ...
                        <div class="card-footer">
                            ...
                            <b class="badge badge-success badge-pill shadow-sm">Discouned Order Total: ₹ <% Response.Write(Session["grandTotalPrice1"]); %> </b>
                            <div class="pt-1">
