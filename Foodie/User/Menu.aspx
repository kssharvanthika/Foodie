                                        ...
                                        <div class="detail-box">
                                            ...
                                            <div class="options">
                                                ...
                                                <asp:LinkButton runat="server" ID="lbAddToCart"
                                                    CommandName="addToCart" CommandArgument='<%# Eval("ProductsId") %>'>
...
c1.024,28.16,24.064,50.688,52.224,50.688h1.024C193.536,443.31,216.576,418.734,215.04,389.55z" />
                                            ...
                                            <asp:LinkButton runat="server" ID="lbReadMore" CommandName="readMore"
                                                CommandArgument='<%# Eval("ProductsId") %>'>Read More</asp:LinkButton>
