...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%
        //string imageUrl = Session["imageUrl"]?.ToString() ?? string.Empty;
                                    ...
                                    <div class="tab-pane fade show active" id="basicInfo" role="tabpanel"
                                        ...
                                        <asp:Repeater ID="rUserProfile" runat="server">
                                            <ItemTemplate>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-3 col-md-2 col5">
                                                ...
                                                <div class="container">
                                                    <div class="row pt-1 pb-1" style="background-color: lightgray">
                                                        <div class="col-4">
                                                            ...
                                                            Payemnt Mode:<%# Eval("PaymentMode").ToString()=="cod"?"Cash on Delivery" : Eval("PaymentMode").ToString().ToUpper() %>
                                                        </div>
                                                        <div class="col-6">
                                                    ...
                                                    <asp:Repeater ID="rOrders" runat="server">
                                                        <HeaderTemplate>
                                                            <table class="table date-table-export table-responsive-sm table-bordered table-hover">
