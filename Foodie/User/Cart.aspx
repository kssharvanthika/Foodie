                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:HiddenField ID="hdnProdQuantity" runat="server" Value='<%#Eval("PrdQty ") %>' />
                        </td>
                        ...
                        <td>
                            <asp:LinkButton ID="lbDelete" runat="server" Text="Remove" CommandName="remove"
                                CommandArgument='<%#Eval("ProductsId ") %>' OnClientClick="return confirm(' do you want remove this item from cart ?');" >
