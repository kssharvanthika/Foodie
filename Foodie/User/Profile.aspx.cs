    ...
    public partial class Profile : System.Web.UI.Page
    {
        ...
        void getUserDetails()
        {
            ...
            if (dt.Rows.Count == 1)
            {
                ...
                {
                    // Handle the case where "ImageUrl" is not present in the DataTable.
                    Session["imageUrl"] = "E:\\MCA\\SEM 3\\c#\\Foodie\\Foodie\\Images\\No_image.png";
                }
                //Session["imageUrl"] = dt.Rows[0]["ImageUrl"].ToString();
        ...
        protected void rPurchaseHistory_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                Repeater repOrder = e.Item.FindControl("rOrders") as Repeater;
                ...
                dt = new DataTable();
                sda.Fill(dt);
               // dt.Columns.Add("TotalPrice", typeof(Int32));
                if (dt.Rows.Count > 0)
                {
                    foreach (DataRow dataRow in dt.Rows)
                    {
